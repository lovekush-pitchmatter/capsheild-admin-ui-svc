  ...
  const campaignData: CampaignCardProps[] = [
    {
      ...
      title: 'BitterBrains',
      description: 'Leading Developer Education company. 15 products, $2M+ annual revenue, 103% growth in 2023',
      valuation: '5.2M',
      target: '1,000,000',
      investors: 154,
    ...
    },
    {
      image: 'pfd_logo.png',
      title: 'PFD',
      description: 'Specialized project management services and business cycle finance solutions',
      valuation: '5.2M',
      target: '1,000,000',
      investors: 277,
      raisedPercentage: '95%',
    ...
    },
    {
      ...
      title: 'LemonRocks',
      description: 'Data-driven startup tracking and analytics platform powered by AI',
      valuation: '5.2M',
      target: '1,000,000',
      investors: 315,
      raisedPercentage: '80%',
