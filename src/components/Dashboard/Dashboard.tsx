...
import FundraisingType from "./FundraisingType";
import InvestorSatisfaction from "./InvestorSatisfaction";
import TotalFundraisingCampaigns from "./TotalFundraisingCampaigns";
import PortfolioValue from "./PortfolioValue";
import SummaryChart from "./SummaryChart";
import InvestmentBreakdown from "./InvestmentBreakdown";
import MyWallet from "./MyWallet";
import { CampaignCardProps, SummaryCardProps } from "../../types/dashboard";
import Layout from "../layout/Layout";

const Dashboard: React.FC = () => {
  const [activeTimePeriod, setActiveTimePeriod] = useState("1D");
  const [activeSummaryCard, setActiveSummaryCard] = useState("Current Value");

  const campaignData: CampaignCardProps[] = [
    {
      image: "bitterbrains_logo.png",
      title: "BitterBrains",
      description:
    ...
    },
    {
      ...
      title: "PFD",
      description:
        "Specialized project management services and business cycle finance solutions",
      valuation: "5.2M",
      target: "1,000,000",
      investors: 277,
      raisedPercentage: "95%",
    ...
    {
      image: "lemonrocks_logo.png",
      title: "LemonRocks",
      description:
        "Data-driven startup tracking and analytics platform powered by AI",
      valuation: "5.2M",
      target: "1,000,000",
      investors: 315,
      raisedPercentage: "80%",
    ...
    {
      image: "frontierbio_logo.png",
      title: "Frontier Bio",
      description: "The future of engineered biology",
      valuation: "5.2M",
      target: "1,000,000",
      investors: 100,
      raisedPercentage: "106%",
    ...
    },
    {
      ...
      icon: (
        ...
        >
          ...
          />
          <path
            d="M18.3332 10.0003C18.3332 14.6003 14.5998 18.3337 9.99984 18.3337C5.39984 18.3337 1.6665 14.6003 1.6665 10.0003C1.6665 5.40033 5.39984 1.66699 9.99984 1.66699"
            stroke="#FFC700"
            stroke-width="1.2"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
          <path
            d="M14.1665 2.5V5.83333H17.4998"
            stroke="#FFC700"
            stroke-width="1.2"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
          <path
            d="M18.3332 1.66699L14.1665 5.83366"
            stroke="#FFC700"
            stroke-width="1.2"
            stroke-linecap="round"
            stroke-linejoin="round"
  ...
  const fundraisingTypes = [
    { name: "Equity", amount: "$2M", color: "#5D40ED" },
    { name: "Seed", amount: "$1.5M", color: "#50C878" },
    { name: "Venture", amount: "$800k", color: "#F000B9" },
  ];

  const investmentBreakdown = [
    { name: "Equity Investments", amount: "$1,200k", color: "#5D40ED" },
    { name: "Seed Investments", amount: "$760k", color: "#50C878" },
    { name: "Venture Capital", amount: "$400k", color: "#F000B9" },
    { name: "Private Equity", amount: "$400k", color: "#FFC700" },
  ];

  return (
    <Layout>
      <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-2 sm:p-4 lg:p-6">
        {/* Funds Raised and Side Divs */}
        <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 lg:gap-6 mb-3 sm:mb-4">
          <FundsRaised
            activeTimePeriod={activeTimePeriod}
            setActiveTimePeriod={setActiveTimePeriod}
          />
          <SideDivs cards={summaryCards} />
        </div>

        {/* Fundraising Type and Investor Satisfaction */}
        <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 lg:gap-6 mb-3 sm:mb-4">
          <FundraisingType types={fundraisingTypes} />
          <InvestorSatisfaction satisfaction={85} />
        </div>

        {/* Total Fundraising Campaigns */}
        <div className="mb-3 sm:mb-4">
          <TotalFundraisingCampaigns campaigns={campaignData} />
        </div>

        {/* Portfolio Value and Summary Chart */}
        <div className="w-full flex flex-col lg:flex-row gap-3 sm:gap-4 mb-3 sm:mb-4">
          <div className="bg-white p-3 sm:p-4 lg:p-6 lg:w-2/5 rounded-lg shadow">
            <PortfolioValue value="$2,760k" />
          </div>
          <div className="bg-white lg:w-3/5 p-3 sm:p-4 lg:p-6 rounded-lg shadow">
            <SummaryChart
              activeTimePeriod={activeTimePeriod}
              setActiveTimePeriod={setActiveTimePeriod}
        ...
        {/* Investment Breakdown and My Wallet */}
        <div className="w-full flex flex-col lg:flex-row gap-3 sm:gap-4 mb-3 sm:mb-4">
